...
@Component({
  selector: 'app-attendance-summary-show',
  templateUrl: './attendance-summary-show.component.html',
  styleUrls: ['./attendance-summary-show.component.scss'],
})
export class AttendanceSummaryShowComponent implements OnInit {
