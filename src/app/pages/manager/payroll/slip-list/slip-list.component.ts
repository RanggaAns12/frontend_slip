...
import { PayrollApiService } from '../../../superadmin/payroll/services/payroll-api.service'; // 👈 Path disesuaikan ke Superadmin
...
@Component({
  selector: 'app-manager-slip-list', // 👈 Selector disesuaikan
  standalone: false,
